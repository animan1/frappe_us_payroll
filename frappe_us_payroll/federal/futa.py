...
from frappe_us_payroll.money import round_money, wages_below_base
...
def calculate_futa_liability(
	*,
	...
	current_taxable_wages = wages_below_base(taxable_wages, prior_taxable_wages, rule.wage_base)
