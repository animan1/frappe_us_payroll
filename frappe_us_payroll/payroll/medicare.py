...
from frappe_us_payroll.payroll.protocols import MedicareSalarySlip
...
def apply_medicare_liability(
	...
	*,
	...
	set_component_amount(salary_slip, DEDUCTIONS, MEDICARE_EMPLOYEE, liability.total_employee)
	set_component_amount(
		salary_slip,
		EMPLOYER_CONTRIBUTIONS,
		MEDICARE_EMPLOYER,
