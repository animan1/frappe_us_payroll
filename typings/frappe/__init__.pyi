...
class _Document(Protocol):
	name: str
	def append(self, fieldname: str, value: Mapping[str, JsonValue]) -> _Document: ...
	def get(self, fieldname: str) -> JsonScalar: ...
	def insert(self, *, ignore_permissions: bool = ...) -> _Document: ...
	def save(self, *, ignore_permissions: bool = ...) -> _Document: ...
	def set(self, fieldname: str, value: JsonValue) -> None: ...
...
def get_single(doctype: str) -> _Document: ...
def get_all(
	doctype: str,
	*,
	filters: Mapping[
