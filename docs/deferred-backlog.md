...
These items are intentionally outside the current foundation slice.

- Select, model, and validate the first real federal deduction.
- Obtain a de-identified TimeTrex payroll fixture with wages, pay frequency, W-4 inputs, relevant YTD values, and
